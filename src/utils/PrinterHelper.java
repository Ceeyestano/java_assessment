...
public class PrinterHelper
{
            ...
            throws ParseException
    {
        ...
        System.out.println( "| Enter student's birth date (mm/dd/yyyy) |" );
        Date birthDate = null;
        ...
        while (birthDate == null) {
           ...
           System.out.println("You have inputted an invalid date format. Please enter the date in the following date format: MM/DD/YYYY.");
           }
        }
